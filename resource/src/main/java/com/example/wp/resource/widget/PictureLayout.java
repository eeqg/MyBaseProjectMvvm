...
public class PictureLayout extends ViewGroup {
	...
	// public PictureLayout setImageLoader(ImageLoaderInterface imageLoader) {
	 ...
	 *
	 */
	public static void setImageLoader(ImageLoaderInterface loader) {
		imageLoader = loader;
	}
	...
	private void loadPictureUri(View child, int index) {
		...
		ImageView pictureView = (ImageView) ((ViewGroup) child).getChildAt(0);
		...
		// );
		if (imageLoader != null) {
			imageLoader.displayImage(getContext(), this.pictureList.get(index), pictureView);
		}
	}
