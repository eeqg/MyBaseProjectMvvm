package com.example.wp.resource.widget.banner.core;
...
public abstract class BaseBanner<T extends BaseBanner> extends FrameLayout {
	...
	protected boolean turning = false;//是否滚动
	...
	public BaseBanner<T> setViewIndex(int viewIndex) {
	...
	private void dealAttrs(Context context, AttributeSet attrs) {
		...
		heightRatio = typedArray.getFloat(R.styleable.Banner_height_ratio, 0);
		typedArray.recycle();
	}
