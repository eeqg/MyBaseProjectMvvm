...
import com.example.wp.resource.widget.banner.core.IndicatorAble;
...
public class IndicatorLayout extends LinearLayout implements IndicatorAble {
	...
	private void dealAttrs(AttributeSet attrs) {
		...
		mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.IndicatorLayout_il_indicator_width, dip8);
		mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.IndicatorLayout_il_indicator_height, dip8);
		mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.IndicatorLayout_il_indicator_margin, dip4);
		mSelectedDrawable = typedArray.getDrawable(R.styleable.IndicatorLayout_il_indicator_selected);
		mUnSelectedDrawable = typedArray.getDrawable(R.styleable.IndicatorLayout_il_indicator_unselected);
		
		mIndicatorFlow = typedArray.getBoolean(R.styleable.IndicatorLayout_il_indicator_flow, false);
		
		mIndicatorShap = typedArray.getInt(R.styleable.IndicatorLayout_il_indicator_shape, 0);
